				...
				if (thisShip == null || lettersToShow[x] == '\0') {
					...
					switch (player.playerOptions.getOption(TrekPlayerOptions.OPTION_ROSTER)) {
						...
						case 2 :
							...
							if (thisShip.currentQuadrant.name.equals("Beta Quadrant")) {
								displayOption = "B";
							} else

							if (thisShip.currentQuadrant.name.equals("Gamma Quadrant")) {
								displayOption = "G";
							} else

							if (thisShip.currentQuadrant.name.equals("Omega Quadrant")) {
								displayOption = "O";
							} else
							
							if (thisShip.currentQuadrant.name.equals("Nu Quadrant")) {
								displayOption = "N";
							} else

                            if (thisShip.currentQuadrant.name.equals("Delta Quadrant")) {
                                displayOption = "D";
                            }
