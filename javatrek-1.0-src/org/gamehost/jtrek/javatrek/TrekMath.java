...
public final class TrekMath {
	...
	/**
	 * Get's the distance between two TrekObjects.
	 * 
	...
	/**
	 * Given a source and target ship, returns whether you can scan a ship.
	 * @param sourceShip The source ship.
	 * @param targetShip The target ship.
	 * @return boolean Whether or not a ship can be scanned.
	 */
	...
	public static int getDecimalFromOctal(String octalCode) {
		try {
			int code1 = new Integer(octalCode.substring(0, 1)).intValue() * 64;
			int code2 = new Integer(octalCode.substring(1, 2)).intValue() * 8;
			int code3 = new Integer(octalCode.substring(2, 3)).intValue();
