...
public class MonitorUI extends JFrame {
    ...
    private void initUI() throws Exception {
        ...
        this.getContentPane().add(shipCountLabel, new XYConstraints(477, 253, 192, 18));
        this.getContentPane().add(shipLabel, new XYConstraints(14, 30, 85, 13));
        this.getContentPane().add(shipScrollPane, new XYConstraints(12, 42, 112, 214));
        this.getContentPane().add(playerLabel, new XYConstraints(131, 30, 111, 13));
        this.getContentPane().add(playerScrollPane, new XYConstraints(129, 42, 112, 214));
        this.getContentPane().add(messageLabel, new XYConstraints(248, 29, 60, 13));
        this.getContentPane().add(messageScrollPane, new XYConstraints(246, 42, 422, 214));
