 ...
 */
public class HeuristicStrong extends Heuristic {

    /** Referenz auf die einzige Instanz der Klasse HeuristicStrong */
    private static HeuristicStrong instance = new HeuristicStrong();
     ...
     * 
     * @return Instanz der Klasse HeuristicStrong
     */
    public static HeuristicStrong getInstance() {
    ...
    public int evaluateBorder( ModelAIInterface game ) {
        ...
        int factorMovesBlack = 2570; // 25 // 70org
        int factorMovesWhite = 2570; // 25 // 70org
        int factorStonesBlack = 10000;
        int factorStonesWhite = 10000;
        int factorPotentialBlack = 1030; // 0 // 30org
        int factorPotentialWhite = 1030; // 0 // 30org
        int whiteAddition = 0;
        int blackAddition = 0;
