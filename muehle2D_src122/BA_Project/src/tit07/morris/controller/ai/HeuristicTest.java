...
public class HeuristicTest extends Heuristic {
    ...
    /** Referenz auf die einzige Instanz der Klasse HeuristicTest */
     ...
     * 
     * @return Instanz der Klasse HeuristicTest
     */
    ...
    public int evaluateBorder( ModelAIInterface game ) {
        ...
        int factorMovesBlack = 2970; // 25 // 70org
        int factorMovesWhite = 2970; // 25 // 70org
        int factorStonesBlack = 10000;
        int factorStonesWhite = 10000;
        int factorPotentialBlack = 2030; // 0 // 30org
        int factorPotentialWhite = 2030; // 0 // 30org
        int whiteAddition = 0;
        int blackAddition = 0;
