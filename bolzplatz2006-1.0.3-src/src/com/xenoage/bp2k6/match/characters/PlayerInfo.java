...
public class PlayerInfo
{
  ...
  {
    //create goal element
    Element ePlayer = parentElement.addElement("player");
    ePlayer.addAttribute("name", name);
    ePlayer.addAttribute("attack", String.valueOf(attack));
    ePlayer.addAttribute("defense", String.valueOf(defense));
    ePlayer.addAttribute("speed", String.valueOf(speed));
    ePlayer.addAttribute("stamina", String.valueOf(stamina));
    ePlayer.addAttribute("headdress", headdress);
    ePlayer.addAttribute("glasses", glasses);
  }
