...
public class PlayerColors
{
   ...
   */
  public void saveToXML(Element parentElement, String id)
  {
    //create goal element
    Element eColors = parentElement.addElement("colors");
    if (id != null)
      eColors.addAttribute("id", id);
    eColors.addAttribute("pattern", (pattern != null ? pattern : ""));
    eColors.addAttribute("skin", ColorTools.getHex(newColors[COLOR_SKIN]));
    eColors.addAttribute("shirt", ColorTools.getHex(newColors[COLOR_SHIRT]));
    eColors.addAttribute("shirt2", ColorTools.getHex(newColors[COLOR_SHIRT2]));
    eColors.addAttribute("pants", ColorTools.getHex(newColors[COLOR_PANTS]));
    eColors.addAttribute("shoes", ColorTools.getHex(newColors[COLOR_SHOES]));
  }
