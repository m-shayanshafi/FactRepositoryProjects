...
public abstract class StadiumObject
{
   ...
   */
  public void addPositionAndRotationToXMLElement(Element e)
  {
    Element ePos = e.addElement("position");
    ePos.addAttribute("x", String.valueOf(position.x));
    ePos.addAttribute("y", String.valueOf(position.y));
    ePos.addAttribute("z", String.valueOf(position.z));
    Element eRot = e.addElement("rotation");
    eRot.addAttribute("x", String.valueOf(rotation.x));
    eRot.addAttribute("y", String.valueOf(rotation.y));
    eRot.addAttribute("z", String.valueOf(rotation.z));
  }
   ...
   */
  public void setPositionAndRotationFromXMLElement(Element e)
  {
    Element ePos = e.element("position");
    if (ePos != null)
    {
    ...
    Element eRot = e.element("rotation");
    if (eRot != null)
    {
