...
public class Weather
{
    ...
    IVideoDriver videoDriver, ISceneManager sceneManager)
  {
    ...
    try
    {
      ...
      Document doc = reader.read("data/weather/" + id + ".xml");
      Element root = doc.getRootElement();
      //sky
      Element eSky = root.element("sky");
      if (eSky != null)
      {
      ...
      //precipitation
      Element ePrecipitation = root.element("precipitation");
      ...
      //lightning
      Element eLightnings = root.element("lightnings");
      if (eLightnings != null)
      {
      ...
      //ambient light
      Element eAmbientLight = root.element("ambientlight");
      if (eAmbientLight != null)
      {
        ...
        videoDriver.setAmbientLight(ambientColor);
      }
      //directional light
      Element eDirectionalLight = root.element("directionallight");
      if (eDirectionalLight != null)
      {
        ...
        directionalNode = sceneManager.addLightSceneNode(
          null, new vector3df(), directionalColor);
      ...
      //stadium lighting
      Element eStadiumLighting = root.element("stadiumlighting");
      if (eStadiumLighting != null)
      {
        stadiumLighting = (eStadiumLighting.getText().equals("on"));
      }
      //ambience sound
      Element eAmbienceSound = root.element("ambiencesound");
      if (eAmbienceSound != null)
      {
        ambienceSound = eAmbienceSound.getText();
      }
      //crowd factor
      Element eCrowdFactor = root.element("crowdfactor");
      if (eCrowdFactor != null)
      {
        crowdFactor = Float.parseFloat(eCrowdFactor.getText());
      }
    }
    catch (Exception ex)
    {
  ...
  {
    float u = GameEngine.UNITS_GAME_TO_IRRLICHT;
    videoDriver.setFog(color, true, u * minDistance, u * maxDistance, 0, false, false);
    ...
    if (lastStepTime > 0)
    {
      ...
      if (lightningsPerSecond > 0)
      {
        ...
        if (!lightningShown)
        {
          ...
          {
            videoDriver.setAmbientLight(lightingColor);
            lightningShown = true;
