...
public class GUISounds
{
  ...
  public GUISounds()
  {
    ...
    soundFocus = soundEngine.createSoundEffect(soundDir + "focus.ogg");
    ...
    try
    {
      ...
      Document doc = reader.read("data/config/guisounds.xml");
      Element root = doc.getRootElement();
      //list of guisounds
      List listGUISounds = root.elements("guisound");
      for (int i = 0; i < listGUISounds.size(); i++)
      {
        Element e = (Element) listGUISounds.get(i);
