  ...
  */
  ...
  public void input(InputEvent event)
  {
    if (event instanceof KeyboardEvent)
    {
      ...
      //int k = kbEvent.keyCode;
      /*  
      if (k == Input.cancel)
      {
        currentScreen.input(Input.cancel);
        //device.closeDevice();
      }
      else if (k == KeyEvent.VK_UP)
      {
        currentScreen.input(Input.up);
      }
      else if (k == KeyEvent.VK_DOWN)
      {
        currentScreen.input(Input.down);
      }
      else if (k == KeyEvent.VK_LEFT)
      {
        currentScreen.input(Input.left);
      }
      else if (k == KeyEvent.VK_RIGHT)
      {
        currentScreen.input(Input.right);
      }
      else if (k == Input.confirm)
      {
        currentScreen.input(Input.confirm);
      }
      else
      {
        //also forward all other keys
        currentScreen.input(k);
      } */
