...
public class GameEngine
{
  ...
  public static final String PROJECT_NAME_VERSION = "Bolzplatz 2006 - v1.0.3";
  ...
  public static void init()
  {
    ...
    Logging.log(Logging.LEVEL_MESSAGES, thisObject,
      "Create Irrlicht device...");
    irrlichtDevice = Jirr.createDeviceJava(E_DRIVER_TYPE.EDT_OPENGL,
      screenDimension.getWidth(), screenDimension.getHeight(),
      screenDepth, screenFullscreen, false, false, null);
    if (osWindows)
