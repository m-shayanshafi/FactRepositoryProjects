...
public class League
{
  ...
  public League(Element eLeague)
  {
    ...
    //list of all teams
    Element eTeams = eLeague.element("teams");
    if (eTeams != null)
    {
      ...
      {
        Element eTeam = (Element) listTeams.get(i);
        teamIDs.add(XMLReader.readAttributeValue(eTeam, "id"));
      }
    }
    //list of all matchdays
    Element eMatchDays = eLeague.element("matchdays");
    if (eMatchDays != null)
    {
      List listMatchDays = eMatchDays.elements("matchday");
      for (int i = 0; i < listMatchDays.size(); i++)
      {
        MatchDay matchDay = new MatchDay((Element) listMatchDays.get(i));
  ...
  public void saveToXML(Element parentElement)
  {
    ...
    Element eLeague = parentElement.addElement("league");
    eLeague.addAttribute("type", String.valueOf(type));
    eLeague.addAttribute("currentmatchday", String.valueOf(currentMatchDayNumber));
    //list of all teams
    Element eTeams = eLeague.addElement("teams");
    for (int i = 0; i < teamIDs.size(); i++)
    {
    ...
    //list of all matchdays
    Element eMatchDays = eLeague.addElement("matchdays");
    eMatchDays.addAttribute("currentmatchday", String.valueOf(currentMatchDayNumber));
