...
public class Season
{
  ...
  public Season(Element eSeason)
  {
    ...
    Element eLeagues = eSeason.element("leagues");
    if (eLeagues != null)
    {
      List listLeagues = eLeagues.elements("league");
      for (int i = 0; i < listLeagues.size(); i++)
      {
        Element eLeague = (Element) listLeagues.get(i);
      ...
      Element eAllstarsLeague = eLeagues.element("allstarsleague");
  ...
  public void saveToXML(Element parentElement)
  {
    ...
    Element eLeague = parentElement.addElement("season");
    eLeague.addAttribute("currentmatchday",
      String.valueOf(currentMatchDay));
    //year of the season
    eLeague.addAttribute("year", String.valueOf(year));
    //save the three leagues and the ÜFA Allstars League
    Element eLeagues = eLeague.addElement("leagues");
