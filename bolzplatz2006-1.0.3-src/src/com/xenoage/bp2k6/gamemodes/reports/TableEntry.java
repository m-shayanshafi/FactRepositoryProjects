...
public class TableEntry
{
   ...
   */
  public TableEntry(Element eTableEntry)
  {
    //parse entry element
  ...
  public void saveToXML(Element parentElement)
  {
    ...
    Element eEntry = parentElement.addElement("entry");
    eEntry.addAttribute("teamid", String.valueOf(teamID));
    eEntry.addAttribute("gameswon", String.valueOf(gamesWon));
    eEntry.addAttribute("gamesdrawn", String.valueOf(gamesDrawn));
    eEntry.addAttribute("gameslost", String.valueOf(gamesLost));
    eEntry.addAttribute("goalsfor", String.valueOf(goalsFor));
    eEntry.addAttribute("goalsagainst", String.valueOf(goalsAgainst));
    eEntry.addAttribute("points", String.valueOf(points));
  }
