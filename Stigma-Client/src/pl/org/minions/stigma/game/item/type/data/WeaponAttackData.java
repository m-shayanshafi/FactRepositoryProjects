...
public class WeaponAttackData
{
    ...
    public static class DataConverter implements
                                     Converter<WeaponAttack, WeaponAttackData>
    {
        /** {@inheritDoc} */
        @Override
        public WeaponAttackData buildData(WeaponAttack object)
        {
            return new WeaponAttackData(object.getDamageType(),
                                        object.getRange(),
                                        object.getCooldown(),
                                        object.getBaseDamage(),
                                        object.getAttack(),
                                        object.getCriticalChance(),
                                        object.getStrenghtBonusStep(),
                                        object.getAgilityBonusStep(),
                                        object.getWillpowerBonusStep(),
                                        object.getFinesseBonusStep(),
                                        object.getStrenghtBonusMin(),
                                        object.getAgilityBonusMin(),
                                        object.getWillpowerBonusMin(),
                                        object.getFinesseBonusMin(),
                                        object.getStrenghtBonusMax(),
                                        object.getAgilityBonusMax(),
                                        object.getWillpowerBonusMax(),
                                        object.getFinesseBonusMax());
        }
        ...
        public WeaponAttack buildObject(WeaponAttackData data)
        {
            ...
            return new WeaponAttack(data.getDamageType(),
                                    data.getRange() == null ? 0
                                                           : data.getRange(),
                                    data.getCooldown() == null ? 0
                                                              : data.getCooldown(),
                                    data.getBaseDamage() == null ? 0
                                                                : data.getBaseDamage(),
                                    data.getAttack() == null ? 0
                                                            : data.getAttack(),
                                    data.getCriticalChance() == null ? 0
                                                                    : data.getCriticalChance(),
                                    data.getStrenghtBonusStep() == null ? 0
                                                                       : data.getStrenghtBonusStep(),
                                    data.getAgilityBonusStep() == null ? 0
                                                                      : data.getAgilityBonusStep(),
                                    data.getWillpowerBonusStep() == null ? 0
                                                                        : data.getWillpowerBonusStep(),
                                    data.getFinesseBonusStep() == null ? 0
                                                                      : data.getFinesseBonusStep(),
                                    data.getStrenghtBonusMin() == null ? 0
                                                                      : data.getStrenghtBonusMin(),
                                    data.getAgilityBonusMin() == null ? 0
                                                                     : data.getAgilityBonusMin(),
                                    data.getWillpowerBonusMin() == null ? 0
                                                                       : data.getWillpowerBonusMin(),
                                    data.getFinesseBonusMin() == null ? 0
                                                                     : data.getFinesseBonusMin(),
                                    data.getStrenghtBonusMax() == null ? 0
                                                                      : data.getStrenghtBonusMax(),
                                    data.getAgilityBonusMax() == null ? 0
                                                                     : data.getAgilityBonusMax(),
                                    data.getWillpowerBonusMax() == null ? 0
                                                                       : data.getWillpowerBonusMax(),
                                    data.getFinesseBonusMax() == null ? 0
                                                                     : data.getFinesseBonusMax());
        }
    }
     ...
     *            will be calculated
     */
    public WeaponAttackData(DamageType damageType,
                            Short range,
                            Short cooldown,
                            Short baseDamage,
                            Short attack,
