...
/**
 * Checks passabilty of {@link MapInstance}.
 */
public class MapPassable extends Passable
{
     ...
     * Constructor.
     * @param map
     *            map instance used for reference of
     *            {@link #isPassable(Position)}.
     */
    public MapPassable(MapInstance map)
    {
        this.map = map;
    }
