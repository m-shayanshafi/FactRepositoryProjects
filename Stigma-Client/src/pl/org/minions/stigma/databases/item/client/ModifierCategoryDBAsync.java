...
/**
 * Modifier category simple asynchronous database.
 * @see ModifierCategory
 * @see SimpleXmlAsyncDB
 */
public class ModifierCategoryDBAsync extends
                                    SimpleXmlAsyncDB<ModifierCategoryWrapper, ModifierCategory, ModifierCategory> implements
                                                                                                                 ModifierCategoryDB
{
    /**
     * Default constructor.
     ...
     *            root URI
     */
    public ModifierCategoryDBAsync(URI uri)
    {
        super(uri,
