 ...
 * @see ItemTypeDBSync
 */
public class OtherTypeDBSync extends XmlSyncDB<OtherType, OtherTypeData>
{
     ...
     *            resources root
     */
    public OtherTypeDBSync(URI uri)
    {
        super(uri, OtherTypeData.class, new OtherTypeData.DataConverter(), true);
    }
