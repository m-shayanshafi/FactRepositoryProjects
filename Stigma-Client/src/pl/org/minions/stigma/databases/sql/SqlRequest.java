...
public abstract class SqlRequest
{
     ...
     */
    protected final boolean executeStatement(PreparedStatement statement,
                                             Object... params)
    {
        int idx = 1;
        for (Object param : params)
        {
            ...
            {
                Log.logger.error(MessageFormat.format("Statement: {0} with params: {1} failed, while setting {2} parameter.",
                                                      statement,
                                                      params,
                                                      idx - 1));
