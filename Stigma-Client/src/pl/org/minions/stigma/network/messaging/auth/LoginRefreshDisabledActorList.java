 ...
 */
public class LoginRefreshDisabledActorList extends SimpleMessage
{
    /**
     * Constructor.
     */
    public LoginRefreshDisabledActorList()
    {
        super(NetworkMessageType.LOGIN_REFRESH_DISABLED_ACTOR_LIST);
    }
}
