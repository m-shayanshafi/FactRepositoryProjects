...
public class MapTypePropertiesPanel extends JPanel
{
    ...
    public MapTypePropertiesPanel()
    {
        ...
        terrainsetField =
                GUIFactory.createTitledComboBoxField("Terrainset:",
                                                     0,
                                                     2,
                                                     160,
                                                     this);
        terrainsetField.setRenderer(new TerrainSetListCellRenderer());
        //terrainsetField.setEditable(false);

        widthField =
                GUIFactory.createTitledNumberSpinnerField("Width:",
                                                          10,
                                                          0,
                                                          3,
                                                          75,
        ...
        heightField =
                GUIFactory.createTitledNumberSpinnerField("Height:",
                                                          10,
                                                          85,
                                                          3,
                                                          75,
        ...
        segmentWidthField =
                GUIFactory.createTitledNumberSpinnerField("Seg. width:",
                                                          10,
                                                          0,
                                                          4,
                                                          75,
        ...
        segmentHeightField =
                GUIFactory.createTitledNumberSpinnerField("Seg. height:",
                                                          10,
                                                          85,
                                                          4,
                                                          75,
        ...
        maxActorsField =
                GUIFactory.createTitledNumberSpinnerField("Max. actors:",
                                                          100,
                                                          0,
                                                          5,
                                                          75,
    ...
    private void updateValues()
    {
        ...
        for (TerrainSet terrainSet : ResourceSetModel.getInstance()
                                                     .getResourceSet()
                                                     .getTerrainSets())
        {
            terrainsetField.addItem(terrainSet);
        }
        TerrainSet selectedTerrainSet =
    ...
    private static class TerrainSetListCellRenderer extends JLabel implements
                                                                  ListCellRenderer
    {
