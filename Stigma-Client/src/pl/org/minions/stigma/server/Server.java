...
public final class Server
{
    ...
    private final class StartingThread implements Runnable
    {
        ...
        public void run()
        {
            ...
            ExtendedWorld world =
                    new ExtendedWorldImpl(new MapDBSync(conf.getResourceUri()));
            ...
            ArchetypeDB archetypeDB =
                    new ArchetypeDBSync(conf.getResourceUri());
            ...
            ProficiencyDB proficiencyDB =
                    new ProficiencyDBSync(conf.getResourceUri());
            ...
            SqlAsyncDB.initGlobalInstance(conf.getSqlUrl(),
                                          conf.getSqlLogin(),
                                          conf.getSqlPassword(),
                                          conf.getSqlDriver());
            ...
            authenticator =
                    new Authenticator(worldManager,
                                      chatManager,
                                      logonDB,
                                      playerLoadDB);
