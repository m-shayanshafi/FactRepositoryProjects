...
/**
 * Listener for event: non-player actor changed map.
 */
public interface ActorChangedMapListener extends UiEventListener
{
    /**
     ...
     *            affected
     */
    void actorChangedMap(ActorChangedMap event, boolean playerActor);
}
