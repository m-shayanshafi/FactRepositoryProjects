...
/**
 * Listener for event: somebody dropped item.
 */
public interface ItemDroppedListener extends UiEventListener
{
    /**
     ...
     *            affected
     */
    void itemDropped(ItemDropped event, boolean playerActor);
}
