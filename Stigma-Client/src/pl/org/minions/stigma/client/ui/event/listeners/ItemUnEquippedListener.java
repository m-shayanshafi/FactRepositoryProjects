...
/**
 * Listener for event: player actor un equipped item.
 */
public interface ItemUnEquippedListener extends UiEventListener
{
    /**
     ...
     *            affected
     */
    void itemUnEquipped(ItemUnEquipped event, boolean playerActor);
}
