...
/**
 * Listener for event: player actor equipped item.
 */
public interface ItemEquippedListener extends UiEventListener
{
    /**
     ...
     *            affected
     */
    void itemEquipped(ItemEquipped event, boolean playerActor);
}
