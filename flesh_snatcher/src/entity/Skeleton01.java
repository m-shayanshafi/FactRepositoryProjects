...
public final class Skeleton01 implements Entity, Scriptable {
	...
	public Skeleton01(	int team, float posX, float posY, float posZ, 
						float angleX, float angleY, float angleZ, 
						float maxLife, float damage, float speed, 
						Node protoNode, Blood[] bloods, 
	...
	public Object clone() {
	    ...
	    return new Skeleton01(team, getPosition().x, getPosition().y, getPosition().z, 
	    					angles.x, angles.y, angles.z, lifeMax, dam, sp, node, bs, 
