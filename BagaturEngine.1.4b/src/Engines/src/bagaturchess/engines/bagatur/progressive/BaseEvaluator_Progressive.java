...
public abstract class BaseEvaluator_Progressive extends EvaluatorAdapter {
	...
	static final boolean USE_LAZY = true;
	...
	protected IEvalCache evalCache;
		
	
	public BaseEvaluator_Progressive(IBitBoard _bitboard, IEvalCache _evalCache, IEvalConfig _evalConfig) {
