...
class MonsterFallingRock extends AnimMonsterLibrary
{
  public AnimMonsterLibrary anim = new AnimMonsterLibrary();

    public MonsterFallingRock()
    {
         anim.name = new String("falling rock");
         anim.nb_images = 11;
      ...
      // Images offset & indexes
         ...
         int array5[] = { 0, 1, 0, 1, 0, 1, 2, 0, 1, 2, 0, 1, 2, 3, 4, 5, 6, 7, 10, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9};
         anim.middle = new Anim( array5 );
         
         int array6[] = { 0 };
         anim.rightside = new Anim( array6 );

         int array12[] = { 8, 7, 10, 9 };
         anim.fall_right = new Anim( array12 );

       
         int array16[] = { 7, 6, 5, 4, 3, 1, 1 };
