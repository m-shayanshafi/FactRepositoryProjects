...
class MonsterRockStone extends AnimMonsterLibrary
{
  public AnimMonsterLibrary anim = new AnimMonsterLibrary();

    public MonsterRockStone()
    {
         anim.name = new String("rockstone");
         anim.nb_images = 4;
      ...
      // Images offset & indexes
         ...
         int array15[] = { 0, 1, 1, 2, 2, 3, 3 };
         anim.hurt_left = new Anim( array15 );
          
         int array16[] = { 0, 1, 1, 2, 2, 3, 3 };
         anim.hurt_right = new Anim( array16 );

         int array17[] = { 0, 0, 0, 0, 0, 0, 0 };
