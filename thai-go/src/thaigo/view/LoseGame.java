...
/** ImageFrame that shows user that he/she's lost.
 * 
 * @author Nol
 *
 */
public class LoseGame extends ImageFrame {

	private GameUI ui;
	private static LoseGame instance;
	 ...
	 */
	public static LoseGame getInstance(GameUI ui){
		if( instance == null)
			instance = new LoseGame(ui);
		return instance;
	}
	 ...
	 * @param ui GameUI
	 */
	private LoseGame(GameUI ui){
		super("images/lose.png",550,325);
		this.ui = ui;
