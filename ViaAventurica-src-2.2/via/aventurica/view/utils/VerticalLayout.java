 ...
 * which case components are stretched horizontally. Unlike FlowLayout, components will not wrap to
 * form another column if there isn't enough space vertically. VerticalLayout can optionally anchor
...
public class VerticalLayout implements LayoutManager {
    ...
    /**
     * Wo sollen sich die Komponenten Vertikal angeordnet wird TOP, BOTTOM oder CENTER
     */
    private int anchor; 
     ...
     *            An int value indicating the vertical seperation of the components
     * @param alignment
     *            An int value which is one of <code>RIGHT, LEFT, CENTER, BOTH</code> for the
     *            horizontal alignment.
     */
     ...
     *            horizontal alignment.
     * @param anchor
     *            An int value which is one of <code>TOP, BOTTOM, CENTER</code> indicating where
