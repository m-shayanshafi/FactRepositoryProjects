 ...
 * @author sjrd
 */
public class BaseRemotablePlayer<G extends RemotableGame,
	T extends RemotableTeam> implements RemotablePlayer
{
	/**
	 * Jeu propriétaire
	 */
	 ...
	 * {@inheritDoc}
	 */
	synchronized public boolean hasPlayedCard()
	{
	 ...
	 * {@inheritDoc}
	 */
	synchronized public boolean isPlayedCardHidden()
	{
	 ...
	 * {@inheritDoc}
	 */
	synchronized public Card getPlayedCard()
	{
		return playedCard;
	}
	 ...
	 */
	synchronized protected void resetPlayedCard()
	{
	 ...
	 */
	synchronized protected void setPlayedCard(Card value, boolean hidden)
	{
		hasPlayedACard = true;
		playedCard = value;
