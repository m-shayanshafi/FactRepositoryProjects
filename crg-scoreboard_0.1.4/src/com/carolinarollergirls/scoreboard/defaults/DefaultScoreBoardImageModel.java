...
public class DefaultScoreBoardImageModel extends ScoreBoardImageListenerManager implements ScoreBoardImageModel {
	...
	public void setName(String n) {
		name = n;
		scoreBoardImageChange(new ScoreBoardImageNameEvent(this, n));
	}
