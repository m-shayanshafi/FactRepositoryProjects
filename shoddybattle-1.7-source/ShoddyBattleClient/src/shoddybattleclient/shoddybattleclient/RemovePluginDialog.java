 ...
 */
public class RemovePluginDialog extends javax.swing.JDialog {
    private JList loadedPlugins;
    private int[] selectedPlugins;
    
    /** Creates new form RemovePluginDialog */
    private RemovePluginDialog(java.awt.Frame parent, JList loadedPlugins) {
        super(parent, true);
    ...
    public static int[] load(java.awt.Frame parent, JList loadedPlugins){
        RemovePluginDialog rpd = new RemovePluginDialog(parent, loadedPlugins);
        rpd.setVisible(true);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new RemovePluginDialog(new javax.swing.JFrame(), jlat).setVisible(true);
            }
        });
    }
