...
public class PlayerSoundsPanel {
	...
	public static JPanel getPlayerSoundsPanel() {
		JPanel pnlPlayerSounds = new JPanel();
		pnlPlayerSounds.setLayout(new GridBagLayout());
		...
		txtMelee.addCaretListener(new CaretListener() {
			public void caretUpdate(CaretEvent arg0) {
				try {
					Sounds.PLAYER_MELEE_ATTACK.setSound(txtMelee.getText());
				} catch (Exception ex) { }
			}
		});
		...
		txtMartArts.addCaretListener(new CaretListener() {
			public void caretUpdate(CaretEvent arg0) {
				try {
					Sounds.PLAYER_MART_ARTS_ATTACK.setSound(txtMartArts.getText());
				} catch (Exception ex) { }
			}
		});
		...
		txtMarksman.addCaretListener(new CaretListener() {
			public void caretUpdate(CaretEvent arg0) {
				try {
					Sounds.PLAYER_MARKSMAN_ATTACK.setSound(txtMarksman.getText());
				} catch (Exception ex) { }
			}
		});
		...
		txtFlame.addCaretListener(new CaretListener() {
			public void caretUpdate(CaretEvent arg0) {
				try {
					Sounds.PLAYER_FLAME_ATTACK.setSound(txtFlame.getText());
				} catch (Exception ex) { }
			}
		});
		...
		txtOther.addCaretListener(new CaretListener() {
			public void caretUpdate(CaretEvent arg0) {
				try {
					Sounds.PLAYER_OTHER_ATTACK.setSound(txtOther.getText());
				} catch (Exception ex) { }
			}
		});
		...
		txtDeath.addCaretListener(new CaretListener() {
			public void caretUpdate(CaretEvent arg0) {
				try {
					Sounds.PLAYER_DIES.setSound(txtDeath.getText());
				} catch (Exception ex) { }
			}
		});
		
		// Add labels
		pnlPlayerSounds.add(lblMelee, lstObjectsC);
		lstObjectsC.gridy = 2;
		pnlPlayerSounds.add(lblMartArts, lstObjectsC);
		lstObjectsC.gridy = 4;
		pnlPlayerSounds.add(lblMarksman, lstObjectsC);
		lstObjectsC.gridy = 6;
		pnlPlayerSounds.add(lblFlame, lstObjectsC);
		lstObjectsC.gridy = 8;
		pnlPlayerSounds.add(lblOther, lstObjectsC);
		lstObjectsC.gridy = 10;
		pnlPlayerSounds.add(lblDeath, lstObjectsC);
		
		// Add text fields
		lstObjectsC.insets = new Insets(0, 20, 5, 20);
		lstObjectsC.gridy = 1;
		pnlPlayerSounds.add(txtMelee, lstObjectsC);
		lstObjectsC.gridy = 3;
		pnlPlayerSounds.add(txtMartArts, lstObjectsC);
		lstObjectsC.gridy = 5;
		pnlPlayerSounds.add(txtMarksman, lstObjectsC);
		lstObjectsC.gridy = 7;
		pnlPlayerSounds.add(txtFlame, lstObjectsC);
		lstObjectsC.gridy = 9;
		pnlPlayerSounds.add(txtOther, lstObjectsC);
		lstObjectsC.gridy = 11;
		pnlPlayerSounds.add(txtDeath, lstObjectsC);
		
		fillInfo();
		
		return pnlPlayerSounds;
	}
	
	private static void fillInfo() {
		txtMelee.setText(Sounds.PLAYER_MELEE_ATTACK.getPath());
		txtMartArts.setText(Sounds.PLAYER_MART_ARTS_ATTACK.getPath());
		txtMarksman.setText(Sounds.PLAYER_MARKSMAN_ATTACK.getPath());
		txtFlame.setText(Sounds.PLAYER_FLAME_ATTACK.getPath());
		txtOther.setText(Sounds.PLAYER_OTHER_ATTACK.getPath());
		txtDeath.setText(Sounds.PLAYER_DIES.getPath());
	}
}
