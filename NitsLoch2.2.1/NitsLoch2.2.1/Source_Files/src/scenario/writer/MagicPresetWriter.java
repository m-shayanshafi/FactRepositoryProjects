...
public class MagicPresetWriter {

	public MagicPresetWriter(Document doc, Element rootElem) {
		Element presetElem = doc.createElement("magicPresets");
		
		for(int i = 0; i < MagicPresets.values().length; i++) {
			MagicPresets preset = MagicPresets.values()[i];
