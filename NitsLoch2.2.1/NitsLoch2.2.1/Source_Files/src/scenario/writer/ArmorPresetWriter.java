...
public class ArmorPresetWriter {

	public ArmorPresetWriter(Document doc, Element rootElem) {
		Element presetElem = doc.createElement("armorPresets");
		
		for(int i = 0; i < ArmorPresets.values().length; i++) {
			ArmorPresets preset = ArmorPresets.values()[i];
