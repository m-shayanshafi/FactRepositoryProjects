...
public class AmmoPresetWriter {

	public AmmoPresetWriter(Document doc, Element rootElem) {
		Element presetElem = doc.createElement("ammoPresets");
		
		for(int i = 0; i < AmmoPresets.values().length; i++) {
			AmmoPresets preset = AmmoPresets.values()[i];
