...
/**
 * Preset configurations for generic shops.  There are up to 20 types
 * of generic shops, each one can have different items available at
 * different prices.  This enum will keep track of those preset shop
 * configurations.
 * @author Darren Watts
 * date 1/12/08
 */
public enum GenericPresets {
	P_000,
	P_001,
	P_002,
	P_003,
	 ...
	 */
	private GenericPresets(){
		items = new ArrayList<StoreItems>();
		prices = new ArrayList<Integer>();
	}
	
	/**
	 * Clears the Generic presets
	 */
	...
	/**
	 * Gets the list of generic items assigned to this preset.
	 * It assigns the appropriate amount of money to the items
	 * that it's keeping track of, and then returns a list of
	 * the items.
	 * @return ArrayList<StoreItems> : Item types.
	 */
