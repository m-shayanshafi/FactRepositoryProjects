...
/**
 * JIhmButton is a simple JButton class with a msgKey string for automatic
 * translations update. Implements JIhmComponens.
 * 
 * @author Bernhard von Gunten
 * @created January, 2005
 */
public class JIhmButton extends JButton implements JIhmComponent {

  static final long serialVersionUID = -5019078840872320629L;
