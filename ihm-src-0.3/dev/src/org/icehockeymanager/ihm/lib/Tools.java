...
/**
 * Tools. - i.E. for String manipulation
 * 
...
public class Tools {
   ...
   */
  public final static String DATE_FORMAT_EU_DATE = "dd.MM.yyyy";

  /**
   * Description of the Field
   */
  public final static String DATE_FORMAT_EU_DATE_SHORTTIME = "dd.MM.yyyy HH:mm";
  ...
  public static String[] getFileNamesInDirByPrefix(String directory, String prefix) throws Exception {
    FilePrefixFilter filePrefixFilter = new FilePrefixFilter(prefix);
   ...
   * @author Bernhard von Gunten <bvg@users.sourceforge.net>
   */
  public static class FilePrefixFilter implements FilenameFilter {
    private String pattern;
