 ...
 * ModelDAO.java
 *
 *   Data Access Object for the Model class. Manages serialisation of Model objects to XML using the XMLDecoder and XMLEncoder classes.
 *
 *   @author Guy Wittig
 *   @version 18-Jun-2006
 *
...
public class ModelDAO {
     ...
     */
    public int saveModel(Model m, String fileName){
        try {
     ...
     * @return Model object constructed from the XML.
     */
    public Model loadModel(String fileName){
        try{
            ...
            Model m = (Model)decoder.readObject();
            decoder.close(); 
            // Validate model
            if(m.validateModel()== Model.MODEL_VALIDATION_SUCCESS)
                return m;
            else
                return null;
        } catch (Exception ex) {
