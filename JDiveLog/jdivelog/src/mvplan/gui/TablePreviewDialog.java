...
public class TablePreviewDialog  extends JDialog implements  ActionListener {
	private static final long serialVersionUID = 4290478608925335294L;
    ...
    ArrayList<SegmentAbstract> segments;
    String heading;
    Frame parent;   
     ...
     */
    public TablePreviewDialog(Frame frame, ArrayList<SegmentAbstract> segments, String heading) {
        super(frame,false);
        this.setTitle(Mvplan.getResource("mvplan.gui.TablePreviewDialog.title.text"));
        this.heading=heading;        
    ...
    public void init()
    {
        ...
        stopTimeCheckBox.setToolTipText("Display stop times.");
        gasFirstCheckBox.setToolTipText("Display gas details first.");
        ...
        Action escapeAction = new AbstractAction(){
			private static final long serialVersionUID = -33745468977452336L;
    ...
    private class ColourButton extends JButton {
		private static final long serialVersionUID = 8049323727952591854L;
