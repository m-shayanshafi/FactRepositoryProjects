...
public class ModelDisplayComponent  extends JComponent implements MouseMotionListener {
	private static final long serialVersionUID = -3895719162359735205L;

	mvplan.model.Model model;   // Points to model 
    ...
    public ModelDisplayComponent(mvplan.model.Model model) {
        setModel(model);
        addMouseMotionListener(this);
        infoFont=new Font(Mvplan.prefs.getPrintFontName(),Font.BOLD,12);       
    }
    
    public synchronized void setModel(mvplan.model.Model model) {
        this.model=model;
        repaint();
    }
