...
{
	private static final long serialVersionUID = -2008500917954760488L;

	private ArrayList<SegmentAbstract> segments;

    /**
     * Constructor for objects of class profileDisplayComponent
     */
    public ProfileDisplayComponent(ArrayList<SegmentAbstract> outputSegments, String heading)
    {
