...
{
	private static final long serialVersionUID = -6414506859812238484L;
    ...
    public GasDialog(Frame frame, Gas g)
    {
        ...
        ppO2Slider.setMaximum((int)(maxMOD*100) );
        ppO2Slider.setValue((int)(sliderMOD*100));
        ...
        he=(int)(gas.getFHe()*100.);
        o2=(int)(gas.getFO2()*100.);
        mod=(int)gas.getMod();
        ...
        Action escapeAction = new AbstractAction(){
			private static final long serialVersionUID = 3749579797160371634L;
    ...
    */
    ...
    public void focusGained(FocusEvent e) {
        ...
        if(tf==(inputMod)) {
            ...
            if (o>0.0) 
                inputMod.setText(String.valueOf( (int)Gas.getMod(o,sliderMOD)));
                //inputMod.setText(String.valueOf( (int)roundDouble(PO2*100/o*Mvplan.prefs.getPConversion()-Mvplan.prefs.getPConversion()))); 
            validateForm();
        }
        tf.selectAll();        
    }
