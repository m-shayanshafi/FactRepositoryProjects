...
public class TablePrinter {
    ...
    public void doPrintTable() {
        ...
        textArea.append(Mvplan.getResource("mvplan.gui.text.ProfilePrinter.settings.text")+"="+(int)(Mvplan.prefs.getGfLow()*100.)+"-"+(int)(Mvplan.prefs.getGfHigh()*100.));                    
        ...
        if (tm.getMaxPO2() > Mvplan.prefs.getMaxPO2()) {
            textArea.append(Mvplan.getResource("mvplan.gui.text.tablePrinter.maxPp02.text")+" "+ ((int)(tm.getMaxPO2()*100)/100.0)+" "+
                    Mvplan.getResource("mvplan.gui.text.tablePrinter.cnsEstimated.text")+'\n');
        }
        textArea.append(Mvplan.getResource("mvplan.gui.text.tablePrinter.oxTox.text")+" "+(int)(tm.getMaxCNS()*100.)+"%"+'\n');                    
