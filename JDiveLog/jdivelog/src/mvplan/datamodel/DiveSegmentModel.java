...
{
	private static final long serialVersionUID = 5811407305265226488L;

	String [] headings;
    ArrayList<SegmentAbstract> knownSegments;    
    public static int COLUMN_COUNT=5;

    public DiveSegmentModel(ArrayList<SegmentAbstract> knownSegments)
    {
