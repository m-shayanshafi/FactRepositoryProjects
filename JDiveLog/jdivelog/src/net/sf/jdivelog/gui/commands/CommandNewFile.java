...
/**
 * Description: Command to create a new divelog file
 * 
 * @author Pascal Pellmont <jdivelog@pellmont.dyndns.org>
 */
public class CommandNewFile implements Command {
    ...
    public CommandNewFile(MainWindow mainWindow) {
     ...
     */
    public void execute() {
        mainWindow.setFile(null);
        mainWindow.setChanged(false);
        mainWindow.setLogBook(new JDiveLog());
    }
