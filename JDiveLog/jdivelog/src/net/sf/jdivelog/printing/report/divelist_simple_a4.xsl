...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:java="http://xml.apache.org/xslt/java" xmlns:uc="net.sf.jdivelog.util.UnitConverter" exclude-result-prefixes="java,uc">
...
<xsl:param name="margin-page-left">10mm 18mm 18mm 7mm</xsl:param>
<xsl:param name="margin-body-right">10mm 7mm 18mm 18mm</xsl:param>
<xsl:param name="margin-body-left">10mm 18mm 18mm 7mm</xsl:param>
