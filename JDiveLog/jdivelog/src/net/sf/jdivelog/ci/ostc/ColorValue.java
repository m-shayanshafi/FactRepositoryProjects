 ...
 * @author Pascal Pellmont <jdivelog@pellmont.dyndns.org>
 */
public class ColorValue implements OSTCValue {
    
    private final int defaultValue;
    private final int currentValue;
    
    public ColorValue(int defaultValue, int currentValue) {
    ...
    public ColorValue(int defaultValue, int currentValue, int defaultSettings) {
        if (!isEightBitValue(defaultValue)) {
