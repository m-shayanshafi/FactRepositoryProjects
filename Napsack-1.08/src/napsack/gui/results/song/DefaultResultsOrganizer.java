...
public class DefaultResultsOrganizer extends AbstractTreeOrganizer {
	public DefaultResultsOrganizer() {
   		...
   		protected NapsackTreeNode createChildNode(final TreeModel treeModel_, final TreePath treePath_, final Object userObject_) {
				return new LeafNode(userObject_) {
					public String toString() {
						return ((SongQueryResults) getUserObject()).getNapsterServiceString();
					}
				};
			}
		});
   ...
   protected NapsackTreeNode createChildNode(final TreeModel treeModel_, final TreePath treePath_, final Object userObject_) {
		return new BranchNode(((SongQueryResults) userObject_).getQueryString());
	}
}
