...
public class FlipResultsTreeProperty extends Property {
	private final static String NAME = "flip_results_tree";
   ...
   public static Property getInstance() {
      if (instance == null) {
			synchronized (FlipResultsTreeProperty.class) {
				if (instance == null) {
         		instance = new FlipResultsTreeProperty();
				}
			}
      }
   ...
   private FlipResultsTreeProperty() {
   }
