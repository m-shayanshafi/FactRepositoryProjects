...
public class SaveOnExitProperty extends Property {
	private final static String NAME = "save_on_exit";
   ...
   public static Property getInstance() {
      if (instance == null) {
			synchronized (SaveOnExitProperty.class) {
				if (instance == null) {
         		instance = new SaveOnExitProperty();
				}
			}
      }
