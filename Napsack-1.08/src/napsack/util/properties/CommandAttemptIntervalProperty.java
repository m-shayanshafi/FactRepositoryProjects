...
public class CommandAttemptIntervalProperty extends Property {
	private final static String NAME = "command_attempt_interval";
   ...
   public static Property getInstance() {
      if (instance == null) {
			synchronized (CommandAttemptIntervalProperty.class) {
				if (instance == null) {
         		instance = new CommandAttemptIntervalProperty();
				}
			}
      }
   ...
   private CommandAttemptIntervalProperty() {
   }
